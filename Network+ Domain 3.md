...
## ⚖️ العلاقة بينهم في سيناريو حقيقي

تخيّل مركز بيانات لشركة مالية:

- تُؤخذ **نسخة احتياطية كل 1 ساعة** →  
    **RPO = 1 ساعة** (لن نخسر أكثر من ساعة بيانات).
    
- إذا توقفت الأنظمة، الإدارة تريدها تعمل خلال **30 دقيقة** →  
    **RTO = 30 دقيقة**.
    
- مهندسو الصيانة عادةً يُصلحون العطل في **25 دقيقة** →  
    **MTTR = 25 دقيقة**.
    
- الأنظمة تتعطل مرة كل **3 أشهر** →  
    **MTBF = 3 أشهر**.
    

لاحظ:

- **RPO و RTO** أهداف (Targets) تحددها الإدارة.
    
- **MTTR و MTBF** نتائج فعلية تُقاس لتقييم الأداء.
