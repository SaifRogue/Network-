...
|المؤشر|يركز على|السؤال الذي يجيب عليه|مثال مبسط|
|---|---|---|---|
|**RPO** (Recovery Point Objective)|**البيانات**|"كم من البيانات يمكن أن نخسرها بدون ضرر جسيم؟"|إذا أخذت آخر نسخة احتياطية قبل 4 ساعات، وانقطعت الأنظمة الآن، فـRPO = 4 ساعات (ستخسر آخر 4 ساعات من البيانات).|
|**RTO** (Recovery Time Objective)|**الزمن**|"كم نتحمل أن يظل النظام متوقفًا قبل أن يؤثر على العمل؟"|لو توقفت خوادم البريد الإلكتروني، والإدارة تقول "لا بأس إن تعطّلنا ساعتين"، فـRTO = ساعتان.|
|**MTTR** (Mean Time To Repair)|**إصلاح العطل**|"كم يستغرق الفنيون عادة لإصلاح العطل الواحد؟"|خادم يسقط، والفريق يعيده للخدمة في 30 دقيقة عادةً → MTTR = 30 دقيقة.|
|**MTBF** (Mean Time Between Failures)|**الاعتمادية (الموثوقية)**|"كم يعيش النظام بالمتوسط قبل أن يتعطل مرة أخرى؟"|نظام يتعطل مرة كل 6 شهور → MTBF = 6 أشهر.|

---
## 🍞 المثال البسيط (المخبز)

|المصطلح|الفكرة بالعربي|تشبيه في المخبز|الجواب عن سؤال|
|---|---|---|---|
|**RPO**|كم بيانات أقدر أخسر؟|كم خبز ممكن نخسره من آخر دفعة مخزّنة؟|“كم خسارة البيانات أتحمّل؟”|
|**RTO**|كم وقت أتحمّل التوقف؟|كم ساعة أقدر أوقف عن البيع قبل زبائني يزعلون؟|“كم وقت التوقف مسموح؟”|
|**MTTR**|كم وقت أصلّح العطل؟|كم يأخذ تصليح الفرن بعد ما خرب؟|“كم نحتاج وقت لإصلاح العطل؟”|
|**MTBF**|كم يعيش قبل يخرب؟|كم مرة يشتغل الفرن قبل ما يخرب ثاني؟|“كم المدة بين الأعطال؟”|

---

## 🧭 التبسيط العقلي (طريقة الحفظ السريع)

|الاختصار|تذكّرها كـ|المفتاح|
|---|---|---|
|**RPO = Point = Backup**|← "نقطة الاسترجاع"|تتعلق بالنسخ الاحتياطية والبيانات|
|**RTO = Time = Restart**|← "وقت الاستعادة"|تتعلق بزمن العودة للعمل|
|**MTTR = Repair**|← "كم نأخذ لتصليح ما كُسر"|تتعلق بالصيانة|
|**MTBF = Between Failures**|← "كم يعيش قبل يخرب ثاني"|تتعلق بالموثوقية|
