...
- **ACL:** تحكم في حركة الترافيك على مستوى الـ Layer 3–4.
    
- **URL Filtering:** تتحكم حسب الرابط أو اسم النطاق.
    
- **Content Filtering:** تتحكم حسب محتوى الرسالة أو الصفحة نفسها.
    
- **Zones:** تنظيم هيكلي للشبكة (Trusted ↔ DMZ ↔ Untrusted).
