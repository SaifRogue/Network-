...
**Static Routing** هو عملية **تحديد المسارات يدويًا** في جهاز التوجيه (Router) من قبل مسؤول الشبكة.  
...
**Dynamic Routing** هو أسلوب يقوم فيه الراوتر **بتعلم المسارات تلقائيًا** من راوترات أخرى عبر **بروتوكولات التوجيه (Routing Protocols)**.  
