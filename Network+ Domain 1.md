...
**القاعدة الذهبية لحساب الشبكات:**

- عدد العناوين الكلي = 2 أس عدد بتات الهوست
    
- عدد العناوين القابلة للاستخدام = (2 أس عدد بتات الهوست) - 2
    

📘 التوضيح:  
نطرح 2 لأن:  
1️⃣ أول عنوان هو **Network Address**  
2️⃣ آخر عنوان هو **Broadcast Address**
