...
- **Physical:** يُعنى بالناقل المادي والإشارات.
    
- **Data Link:** ينقل الإطارات ويكشف الأخطاء.
    
- **Network:** يختار المسارات باستخدام العناوين المنطقية.
    
- **Transport:** يضمن تسليم البيانات بدقة (TCP) أو سرعة (UDP).
    
- **Session:** ينسق الاتصالات ويعيدها عند الانقطاع.
    
- **Presentation:** يجعل البيانات قابلة للفهم بين الأنظمة المختلفة.
    
- **Application:** يتعامل مباشرة مع المستخدم والتطبيقات.
---
