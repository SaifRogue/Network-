...
## ✦ **Subnet Masks (CIDR Notation ↔ Decimal)**
...
**السؤال:**  
تم إعطاء الشركة الشبكة `192.168.10.0/24`  
كم عدد عناوين الـ IP القابلة للاستخدام (usable)؟

**الحل:**  
مجرد أن ترى `/24` → **تعرف مباشرة أن عدد العناوين القابلة للاستخدام هو ✅ 254**
