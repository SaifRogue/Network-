...
عدد العناوين الكلي=2(عددبتاتالهوست)\text{عدد العناوين الكلي} = 2^{(عدد بتات الهوست)}عدد العناوين الكلي=2(عددبتاتالهوست) عدد العناوين القابلة للاستخدام=2(عددبتاتالهوست)−2\text{عدد العناوين القابلة للاستخدام} = 2^{(عدد بتات الهوست)} - 2عدد العناوين القابلة للاستخدام=2(عددبتاتالهوست)−2

> نطرح 2 لأن أول عنوان هو **Network Address** وآخر عنوان هو **Broadcast Address**.
...
- عدد بتات الهوست: 32−24=832 - 24 = 832−24=8
    
- عدد العناوين الكلي: 28=2562^8 = 25628=256
    
- العناوين القابلة للاستخدام: 256−2=254256 - 2 = 254256−2=254
    

✅ **الإجابة: 254 usable IPs**
